...
エクスポート　Ctrl + E（Cmd + E）　電子書籍やPDF、HTMLへのエクスポートを行うウィンドウを開きます（詳細は後述）。
...
　ウィンドウ右上の×ボタン、あるいはF4キーを押すと画面が閉じます。
...
Q. 「高度な設定」ウィンドウが閉じられなくなりました。閉じるボタンもF4キーも効きません。
